...
public class PubkeyAddBottomSheetDialog extends BottomSheetDialogFragment
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.bottomsheet_add_fido2_security_key).setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bottomsheet_add_piv_security_key:
                ...
                break;
            case R.id.bottomsheet_add_fido2_security_key:
                listener.onBottomSheetAddFido2SecurityKey();
                break;
            case R.id.bottomsheet_setup_openpgp_security_key:
                OpenPgpKeyAlgorithmConfig algorithmConfig;
                switch (spinner.getSelectedItemPosition()) {
                    case 0:
                        algorithmConfig = OpenPgpKeyAlgorithmConfig.CURVE25519_GENERATE_ON_HARDWARE;
                        break;
                    case 1:
                        algorithmConfig = OpenPgpKeyAlgorithmConfig.NIST_P256_GENERATE_ON_HARDWARE;
                        break;
                    case 2:
                        algorithmConfig = OpenPgpKeyAlgorithmConfig.NIST_P384_GENERATE_ON_HARDWARE;
                        break;
                    case 3:
                        algorithmConfig = OpenPgpKeyAlgorithmConfig.NIST_P521_GENERATE_ON_HARDWARE;
                        break;
                    case 4:
                        algorithmConfig = OpenPgpKeyAlgorithmConfig.RSA_2048_UPLOAD;
                        break;
                    default:
    ...
    public interface PubkeyAddBottomSheetListener {
        ...
        void onBottomSheetAddFido2SecurityKey();

        void onBottomSheetSetupSecurityKey(OpenPgpKeyAlgorithmConfig algorithmConfig);
    }
}

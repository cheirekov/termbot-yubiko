	...
	public static String convertToOpenSSHFormat(PublicKey pk, String origNickname) throws IOException, InvalidKeyException {
		...
		if (pk instanceof RSAPublicKey) {
			...
			return Ed25519Verify.ED25519_ID + " " +
					...
					" " + nickname;
		} else if ("EdDSA".equalsIgnoreCase(pk.getAlgorithm()) || "Ed25519".equalsIgnoreCase(pk.getAlgorithm())) {
			try {
				Ed25519PublicKey edPub = new Ed25519PublicKey(new X509EncodedKeySpec(pk.getEncoded()));
				return Ed25519Verify.ED25519_ID + " " +
						String.valueOf(Base64.encode(Ed25519Verify.encodeSSHEd25519PublicKey(edPub))) +
						" " + nickname;
			} catch (InvalidKeySpecException e) {
				throw new InvalidKeyException("Unable to convert Ed25519 public key", e);
			}
		}

...
public class HostBean extends AbstractBean {
	...
	public void setJumpHostId(long jumpHostId) {
		this.jumpHostId = jumpHostId;
	}

	public long getJumpHostId() {
		return jumpHostId;
	}
	...
	public void setSsmRoleArn(String ssmRoleArn) {
		this.ssmRoleArn = ssmRoleArn;
	}

	public String getSsmRoleArn() {
		return ssmRoleArn;
	}
	...
	public static HostBean fromContentValues(ContentValues values) {
		...
		host.setRememberPassword(Boolean.TRUE.equals(values.getAsBoolean(HostDatabase.FIELD_HOST_REMEMBERPASSWORD)));
	...
	public String toString() {
		...
		if (SSH.getProtocolName().equals(protocol)) {
			...
			builder.append(username).append("@").append(hostname);

			if (port != defaultPort) {
				builder.append(":").append(port);
			}

			if (postLogin != null && !postLogin.equals("")) {
				builder.append("/").append(postLogin);
			}
